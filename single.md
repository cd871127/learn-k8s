...
修改`/etc/kubernetes/manifests/kube-apiserver.yaml`, spec.containers添加`--token-auth-file=/etc/kubernetes/pki/basic_auth_file`
...
metadata:
  annotations:
    kubeadm.kubernetes.io/kube-apiserver.advertise-address.endpoint: 192.168.65.133:6443
...
spec:
  ...
  - command:
    - kube-apiserver
    - --advertise-address=192.168.65.133
